...
-- Requête pour trouver les employé dont l'id est compris entre 5 et 10 inclus
SELECT *
FROM EMPLOYEE Emp
...
-- Requête permettant de retourner les employé dont la date d'embauche est comprise dans un interval de valeurs
SELECT Emp.EMP_ID,
		Emp.FIRST_NAME,
		Emp.LAST_NAME,
		Emp.START_DATE,
